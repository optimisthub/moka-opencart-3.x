...
$_['PaymentDealer.CheckPaymentDealerAuthentication.VirtualPosNotFound'] = 'Bu bayi için sanal pos tanımı yapılmamış.';
$_['PaymentDealer.CheckDealerPaymentLimits.DailyDealerLimitExceeded'] = 'Bayi için tanımlı günlük limitlerden herhangi biri aşıldı.';
$_['PaymentDealer.CheckDealerPaymentLimits.DailyCardLimitExceeded'] = 'Gün içinde bu kart kullanılarak daha fazla işlem yapılamaz.';
$_['PaymentDealer.CheckCardInfo.InvalidCardInfo'] = 'Kart bilgilerinde hata var.';
$_['PaymentDealer.DoDirectPayment3dRequest.InstallmentNotAvailableForForeignCurrencyTransaction'] = 'Yabancı para ile taksit yapılamaz.';
$_['PaymentDealer.DoDirectPayment3dRequest.ThisInstallmentNumberNotAvailableForDealer'] = 'Bu taksit sayısı bu bayi için yapılamaz.';
